                ...
                <div class="mb-4 col-lg-12 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <h5><i class="fa fa-tag"></i> Manage New Products</h5>
                                </div>
                                {{-- <div class="col-md-3">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#newProductModal"
                                        class="btn btn-outline-success">Add New Product</a>
                                    @include('admin.modal.add_newproducts')
                                </div> --}}
                            </div>
                            <hr>
                            <div class="table-responsive">
                                <table class="table mt-3 table-striped table-sm newproducts-datatable">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Image</th>
