                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        {{-- <a href="#" style="text-decoration: none;color: #dfdada;">
                                            <h1 class="text-capitalize bigFont"> DISCOVER&nbsp;THE&nbsp;INDUSTRIES</h1>
                                        </a> --}}
                                        <h1 class="text-capitalize bigFont" style=" text-align: center;display: block;margin: auto;">DISCOVER&nbsp;THE&nbsp;INDUSTRIES</h1>
                                    </div>
                                    @foreach ($fetchsubIndustry as $r)
                                    <div class="carousel-item">
                                        <a href="#">
                                           <h1 class="text-capitalize bigFont d-block mx-auto"><a href="#" style="text-decoration: none;color:#fff;text-align:center">{{ Str::upper($r->sub_industry_name) }}</a></h1>
                                        </a>
                                    </div>
                                    @endforeach
                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                            ...
                            <div class="card card8">
                                <div class="card-header"
                                    ...
                                    <div class="row">
                                        <div class="col-10"><i class="fa fa-industry" style="color:#FF7519"></i> {{ $countallindustry_items_ }} INDUSTRIES & MANUFACTURES SERVICE YOU MAY LIKE...</div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-2 table-data_ap">
                                    ...
                                    <div class="mx-1 row " id="dynamic_content_ap">
                                        ...
                                        @forelse($fetchsubIndustry as $r)
                                        {{-- --}}

                                        <div class="row">
                                            <div class="col-9">
                                                <a href="{{route('guest.industryitems', ['industry_id' => encrypt($r->industry_id), 'sub_industry_id' => encrypt($r->sub_industry_id),  'id' => encrypt(1)])}}"
                                                    class="_hrefCss" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="MORE BOOTS"><span class="text-dark2"><i
                                                            class="fa fa-plus-square"></i> {{ Str::upper($r->sub_industry_name) }} <span
                                                            class="badge rounded-pill bg-light"
                                                            style="color:#FF7519">{{ $r->total_subindustries }}</span></span></a>
                                            </div>
                            ...
                            ->get();
                                    ...
                                    @endphp
                                     <div class="row g-1">
                                              ...
                                              @forelse ($fetchallIndustry as $key => $item)
                                                @if ($item->sub_industry_id == $r->id)
                                                ...
                                                <div class="col-md-3 d-flex justify-content-center fade_in u-fade-type-left js-scroll-trigger">
                                                    <div class="mb-4 card"> {{-- shadow-sm --}}
                                                        ...
                                                        <a href="{{ route('guest.industriesitemsservice', ['sub_industry_id' =>encrypt($item->industryid), 'user_id' =>encrypt($item->uuser_id)]) }}" class="hrefCss3"> <h6 class="text-center card-title fw-bold" style="text-transform: uppercase;">{{ $item->company_name }}</h6></a>
