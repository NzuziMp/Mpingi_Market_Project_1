                        ...
                        <div class="" id="" style="">
                                ...
                                <a href="#" class="">
                                    ...
                                    <span style="font: 10pt/130% Helvetica, Arial, sans-serif;"> &nbsp;<span
                                            class="badge bg-light text-dark"><span
                                                style="color:#FF7519;font-weight:bolder;font-size:13px">0</span></span></span>
                                </a>
                            </p>
                            <p id="servicesSection" class="mt-3"
                                style="margin-left:0.3%;margin-bottom:5px; margin-top:1%; background-color:#FFF; background-image:none; border:none;">
                            ...
                            <p id="servicesSection" class="mt-3"
                                ...
                                <a href="#" class="">
                                    ...
                                    <span style="font: 10pt/130% Helvetica, Arial, sans-serif;"> &nbsp;<span
                                            class="badge bg-light text-dark"><span
                                                style="color:#666;font-weight:bolder;font-size:13px">0</span></span></span>
                                </a>
                            </p>
                            <p id="servicesSection" class="mt-3"
                                style="margin-left:0.3%;margin-bottom:5px; margin-top:1%; background-color:#FFF; background-image:none; border:none;">
            ...
            <div class="mb-4 col-lg-8 mb-lg-0">
                <div class="mb-3 card card6">
                    <div class="card-header"
                        style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                        <div class="row">
                            <div class="col-11"><i class="fa fa-bicycle"></i> Active life (0)
                            </div>
                        ...
                        <h6 class="textHeaderTitle">
                          ...
                          <div class="row">
                              ...
                              <div class="col-6">
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Amateur Sports Teams">
                                    <div class="mb-1">
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Aquariums">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Aquariums
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Badminton">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Badminton
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Beaches">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Beaches
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Boating">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Boating
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Climbing">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Climbing
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Diving">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Diving
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Fitness & Instruction">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Fitness & Instruction
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Golf">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Golf
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Gymnastics">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Gymnastics
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Hiking">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Hiking
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Horseback Riding">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Horseback Riding
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Kiteboarding">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Kiteboarding
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Laser Tag">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Laser Tag
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Mini Golf">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Mini Golf
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Paddleboarding">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Paddleboarding
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Parks">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Parks
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Rafting/Kayaking">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Rafting/Kayaking
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Rock Climbing">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Rock Climbing
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Skydiving">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Skydiving
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Spin Classes">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Spin Classes
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Squash">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Squash
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Surfing">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Surfing
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Tennis">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Tennis
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Tubing">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Tubing
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                              ...
                              <div class="col-6">
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Amusement Parks">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Amusement Parks
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Archery">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Archery
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Basketball Courts">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Basketball Courts
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Bike Rentals">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Bike Rentals
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Bowling">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Bowling
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Disc Golf">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Disc Golf
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Fishing">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Fishing
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Go Karts">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Go Karts
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Gun/Rifle Ranges">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Gun/Rifle Ranges
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Hang Gliding">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Hang Gliding
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Horse Racing">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Horse Racing
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Hot Air Balloons">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Hot Air Balloons
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Lakes">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Lakes
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Leisure Centers">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Leisure Centers
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Mountain Biking">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Mountain Biking
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Paintball">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Paintball
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Playgrounds">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Playgrounds
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Recreation Centers">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Recreation Centers
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Skating Rinks">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Skating Rinks
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Soccer">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Soccer
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Sports Clubs">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Sports Clubs
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Summer Camps">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Summer Camps
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Swimming Pools">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Swimming Pools
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Trampoline Parks">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Trampoline Parks
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Zoos">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Zoos
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
