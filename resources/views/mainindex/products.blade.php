    ...
    <header class="">
        <div id="slide-container">
            <div id="slide-first-element">
              <img class="slide-image" src="{{ asset('assets/images/back3.jpg') }}">
            </div>
                            ...
                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                            ...
                                            <h1 class="text-capitalize bigFont" style=" text-align: center;display: block;margin: auto;">MPINGI MARKET</h1>

                                    </div>
                                    @foreach ($ProductTypeGroupCount as $r)
                                    <div class="carousel-item">
                                        <a href="#">
                                            <h1 class="text-capitalize bigFont d-block mx-auto"><a href="{{ route('viewproductsdetails', ['product_type' =>  $r->slug, 'product_id' =>  encrypt($r->id), 'upload_id' => encrypt($row->ImageIDS)]) }}" style="text-decoration: none;color:#fff">{{ Str::upper($r->product_type) }}</a></h1>
                                        </a>
                                    </div>
                                    @endforeach
                                            ...
                                            data-bs-placement="top" title="{{ $row->category_name_desc }}">
                                              ...
                                              <div class="d-flex">
                                                ...
                                                <div class="flex-1 mt-3" style="margin-left:3%">
                                                    <img
                                                    src="{{ asset('assets/images/') . $row->category_image }}"
                                        ...
                                        <div class="accordion-body panelx2">
                                            ...
                                            <p class="">
                                                <a href="{{ route('guest.viewdetailscategories', ['subcategory_id' => encrypt($data->id), 'category_id' =>encrypt($row->id)]) }}" class="link-secondary sidemenu_a" data-aos="zoom-in"
                                                    ...
                                                    <img src="{{ asset('assets/icons_2/') . $data->sub_category_image }}" alt="" width="30"
                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                            ...
                            <div class="card card8">
                                <div class="card-header"
                                    ...
                                    @endphp
                                    <div class="row">
                                        <div class="col-10"><i class="fa fa-tags" style="color:#FF7519"></i> {{ $countallproducts }} PRODUCTS
                                            NEAR YOU</div>
                                    </div>
                                </div>
                               ...
                               @php
                                $getimagex =  DB::table('tbl_product_items')
                                    ...
                                    ->where(['tbl_sub_products.id'=> $r->sub_product_id, 'tbl_product_items.expire_status' => 1])
