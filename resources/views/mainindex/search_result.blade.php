                    ...
                    <div class="card-header"
                        ...
                        <div class="row">
                            <div class="col-11">
                                    ...
                                    class="titleDetails">{{ $countryname->name }}</span>
                                <font color="#ff7519">&nbsp;&nbsp;»</font>
                                <span style="color:#fff; font-weight:bold"
                                class="titleDetails">{{ $statename->name }}</span>
                                <font color="#ff7519"> &nbsp;» </font>
                                <span style="color:#fff; font-weight:bold"
                                class="titleDetails">{{ $cityname->name }}</span>
                                    <span class="badge_3">
                                        0
                                    </span>
                            </div>
                    ...
                    <div class="card-body">
                       <div class="myDiv_ads">
                            <p style="margin-left:20px; margin-top:0px; background-color:#FFF; border:none;">
                                <font color="#ff7519">»</font>   <font color="#ff7519">»</font>
                                 <font color="#ff7519"></font></p><font color="#ff7519">
                            <p style="margin-top:-25px; background-color:#FFF; border:none;" align="center" class="p">
                                <i class="fa fa-tags fa-5x"></i><br><br><span class="titleDetails_">No Results Found</span></p>
                            </font>
                        </div>
                    </div>
                </div>
