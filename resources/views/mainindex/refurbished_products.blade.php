                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                    ...
                    <div class="card card8">
                        <div class="card-header"
                         ...
                         @endphp
                            <div class="row">
                                <div class="col-10"><i class="fa fa-tags" style="color:#FF7519"></i> {{ $countallproductsrefurbished }} PRODUCTS
                                    NEAR YOU</div>
                            </div>
                        </div>
                        ...
                        <div class="mt-2 table-data">
                            ...
                            ->where(['tbl_sub_products.id'=> $r->sub_product_id, 'tbl_product_items.expire_status' => 1, 'tbl_product_items.type'=> 'Refurbished'])
