                                ...
                                <div class="container">
                                 <form method="POST" action="{{ route('searchresult') }}">
                                    ...
                                    <div class="row align-items-start g-2 menuAlign" data-aos="fade-down" data-aos-duration="1000" >
                                        <div class="col-md-3">
                                            <select name="country" class="form-select example country-dropdown country"
                                                aria-label="Default select" id="borderinput" required>
                                        ...
                                        <div class="col-md-2">
                                            <select name="state" class="form-select state-dropdown state"
                                                aria-label="Default select example" id="borderinput" required>
                                                <option value="" selected="true" disabled="disable">&larr; @if(session()->get('locale') === 'fr') Sélectionner état @else Select State @endif
                                                    &rarr;</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            <select name="city" class="form-select city-dropdown city"
                                                aria-label="Default select example" id="borderinput" required>
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control job_name" name="job_name" placeholder="48 @if(session()->get('locale') === 'fr') Produits près de chez vous @else Products near you @endif"
                                                id="borderinput" required autocomplete="off">
                                                <div id="jobsList"></div>
                                        </div>
                                        <div class="col-md-1">

                                            <button type="submit"  class="btn btnColorfind">@if(session()->get('locale') === 'fr') RECHERCHER @else FIND&nbsp;PRODUCTS @endif</button>
            ...
            <div class="mb-4 col-lg-8 mb-lg-0">
                <div class="mb-3 card card6">
                    <div class="card-header"
                        style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold;">
                        <div class="row">
                            <div class="col-11"><i class="fa fa-briefcase"></i>  3 JOB SEEKERS YOU MAY LIKE
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-data_s">
                            <div class="row" id="dynamic_content_s">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            {{ $jobseekers->links('pagination.custom')}}
                                        </div>
                                    </div>
                                  </div>

                                @forelse($jobseekers as $row)
                                <div class="col-md-6">
                                    <a href="{{ route('jobitems',['id'=> encrypt($row->id) ]) }}" class="removeU">
                                        <div class="mb-1">
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="#" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="Home Improvement services (0)">
                                    <div class="mb-1">
                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                        Home Improvement...
                                      <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
