                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                            ...
                            <div class="card card8">
                                <div class="card-header"
                                    style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                                    <div class="row">
                                        <div class="col-10"> <i class="fa fa-cogs"></i> 3 JOB SEEKERS YOU MAY LIKE </div>
                                    </div>
                                </div>
                                ...
                                <div class="mx-1 mt-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <label>
                                            <select size="1" name="" id="search_pages_as" aria-controls="example">
                                ...
                                <div class="mx-2 mt-2 table-data_as">
                                  <div class="row" id="dynamic_content_as">
                ...
                <div class="mb-4 col-lg-2 mb-lg-0">
                    ...
                    <div class="mb-3 card card7">
                        <div class="card-header"
                            style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                            <div class="row">
                                <div class="col-10"><iclose class="fa fa-fa fa-wrench"></iclose> <span class="counter"
                                        data-target="17">0</span> SERVICES</div>
                                <div class="col-2"><i class="fa fa-times text-dark -icon7"></i></div>
                            </div>
                        </div>
