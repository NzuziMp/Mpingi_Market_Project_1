                    ...
                    <div class="card card8">
                        <div class="card-header"
                            ...
                            @php
                                ...
                                @endphp
                            <div class="row">
                                <div class="col-10"><i class="fa fa-tags" style="color:#FF7519"></i> {{ $countallproductsnew }} PRODUCTS
                                    NEAR YOU</div>
                            </div>
                        </div>
                        ...
                        <div class="mt-2 table-data">
                            ...
                            ->where(['tbl_sub_products.id'=> $r->sub_product_id, 'tbl_product_items.expire_status' => 1, 'tbl_product_items.type'=> 'New'])
