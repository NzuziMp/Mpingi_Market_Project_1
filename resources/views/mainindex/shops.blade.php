                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            @endphp
                            <div class="row">
                                <div class="col-11" style="font-weight:bold"><i class="fa fa-shopping-cart"></i> {{ $countallstore }} Shops Nearby
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control search_input_" placeholder="Search Keywords..."
                                            id="search_input">
                                                            ...
                                                            <div class="">
                                                             <center>
                                                              <div style="background-color:#3b3b3b;height:200px">
                                                                <i class="mb-1 {{ $row->business_icon }} fa-6x IClass"></i>
                                                                  <h6 class="h6Css">{{ \Illuminate\Support\Str::upper(Str::limit($row->business_name,16))}}</h6>
                                                                </div>

                                                                <p class="mt-2 PClass">
                                                                 <a href="{{ route('shopsid',['id'=>encrypt($row->id)]) }}"  class="hrefCss3" data-bs-toggle="tooltip" data-bs-placement="top" title="Order from {{ \Illuminate\Support\Str::lower($row->business_name)}}">
                                                                    <i class="{{ $row->business_icon }}"></i>
                                                                    Order Now!
                                                                 </a>
                                                              </p>
                                                             </center>
