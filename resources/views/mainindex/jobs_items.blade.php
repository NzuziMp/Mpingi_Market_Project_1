                    ...
                    <div class="card-header"
                        ...
                        <div class="row">
                            ...
                            <div class="col-11">
                             ...
                             <a href="#" class="hrefCss3s" style="color:#FFF">{{$row->job_category_name_en}}  </a>
                            @endforeach
                            ...
                            <a href="#" class="hrefCss3s" style="color:#FFF">@foreach ($subservices as $row0)   {{ $row0->sub_service_name }}  @endforeach </a> --}}
                             <font color="#ff7519">&nbsp;&nbsp;» </font>
                              <a href="#" class="hrefCss3s" style="color:#FFF">@foreach ($jobname as $row1)   {{ $row1->company_name }}  @endforeach </a>
