            ...
            <div class="mb-3 card card4">
             ...
             <div class="mb-4 col-lg-8 mb-lg-0">
                ...
                <div class="mb-3 card card6">
                    <div class="card-header"
                        ...
                        <div class="row">
                            ...
                            <div class="col-11">
                                <i class="{{ $row->service_image }}"></i>
                             <a href="#" class="hrefCss3s" style="color:#FFF">{{$row->service_name}}  </a>
                            @endforeach
                            {{-- <font color="#ff7519">&nbsp;&nbsp;» </font>
                            <a href="#" class="hrefCss3s" style="color:#FFF">@foreach ($subservices as $row0)   {{ $row0->sub_service_name }}  @endforeach </a> --}}
                             <font color="#ff7519">&nbsp;&nbsp;» </font>
                              <a href="#" class="hrefCss3s" style="color:#FFF">@foreach ($subservices3 as $row1)   {{ $row1->sub_service_3_name }}  @endforeach </a>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            {{-- <a  href="{{ route('login') }}" id="globalheadernavhref"><button type="button" class="mb-4 btn btnColor">Add new</button></a> --}}
                        </div>
                        <div class="col-md-2">
                                <a data-bs-toggle="modal" data-bs-target="#loginc_Modal">
                                <span data-bs-toggle="tooltip" data-bs-placement="top" title="Add new" class="btn btn-large tooltip_nzuzi" style="background-color: #f24d23;color:#fff"><i class="fa fa-plus-square"></i> </span></a>
                    ...
                    <div class="mx-2 row" id="dynamic_content">
                       {{-- --}}
