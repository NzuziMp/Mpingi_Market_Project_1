            ...
            <div class="mb-4 col-lg-8 mb-lg-0">
                <div class="mb-3 card card6">
                    <div class="card-header"
                        ...
                        <div class="row">
                            <div class="col-11">
                                <i class="fa fa-industry"></i> <span style="color:#fff; font-weight:bold"
                                    class="titleDetails">@foreach ($name as $row)
                                    {{ $row->category_name }}
                                    @endforeach</span>
                                <font color="#ff7519">&nbsp;&nbsp;»</font>
                                <i class="fa fa-cogs"></i> <span style="color:#fff; font-weight:bold"
                                class="titleDetails">@foreach ($namesub as $row1){{ $row1->sub_category_name }}  @endforeach</span></span>
                                    <span class="badge_3">
                                        0
                                    </span>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 g-2 d-flex">
                                <a data-bs-toggle="modal" data-bs-target="#mainlogin_Modal" id="pic" >
                                    <span class="btn btn-large" style="color: #ffffff; background-color: #f24d23;" data-bs-toggle="tooltip" data-bs-placement="top" title="Add New @foreach ($namesub as $row1){{ $row1->sub_category_name }}  @endforeach" ><i class="fa fa-plus-square"></i>
                                </span>
                                </a>&nbsp;&nbsp;
                                <a href="#listView_1" data-toggle="tab" style="border:1px solid #e6e6e6;background-color:#e6e6e6;border-radius:6px"><span class="btn btn-large"><i class="fa fa-list"></i></span></a>
                            </div>
                        </div>
                       <div class="myDiv_ads">
                            <p style="margin-left:20px; margin-top:0px; background-color:#FFF; border:none;">

                             <font color="#ff7519">
                            <p style="margin-top:-25px; background-color:#FFF; border:none;" align="center" class="p">
                                <i class="fa fa-industry fa-5x"></i><br><br><span class="titleDetails_">No @foreach ($namesub as $row1){{ $row1->sub_category_name }}  @endforeach</span><br>
                               <a data-bs-toggle="modal" data-bs-target="#mainlogin_Modal" href="#login1" id="pic" title="Post Now!" class="" style="font: 10pt/130% Helvetica, Arial, sans-serif;font-weight:bold;"><button class="mt-2 btn btn-danger" style="background-color: #ff7519;border-color:#ff7519"><i class="fa fa-plus-square"></i> Post @foreach ($namesub as $row1){{ $row1->sub_category_name }}  @endforeach for free Now!</button></a></p>
                            </font>
                        </div>
                    </div>
                </div>
