                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                            ...
                            <div class="card card8">
                                <div class="card-header"
                                    style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                                    <div class="row">
                                        <div class="col-10"> <i class="fa fa-briefcase"></i> 3 JOBS AVAILABLE YOU MAY APPLY or POST </div>
                                    </div>
                                </div>
                                ...
                                <div class="mx-1 mt-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <label>
                                            <select size="1" name="" id="search_pages_a" aria-controls="example">
                                ...
                                <div class="mx-2 mt-2 table-data_a">
                                  <div class="row" id="dynamic_content_a">
