                                ...
                                @foreach ($servicesid as $m)
                                    ...
                                    <div class="col-11">
                                        ...
                                        <i class="{{ $m->service_image }}" style="font-size: 1.3rem;color:#FF7519;"
                                             height="40"
                                            width="40"></i>
                                           <span style="color:#FF7519;">{{ $m->service_name }}</span>
                                             ...
                                             <div class="col-md-8">
                                                ...
                                                <font color="#8a6d3b" class="py-2"><i
                                                        ...
                                                        style="font-size:1.9rem"></i> <b>POST STEP <font
                                                            color="#FF7519"><b>1</b></font></b> <b>OF 3</b>
                                                </font>
                                                @endforeach
                                            </p>
                                             </div>
                                            ...
                                            <div class="mb-3 card card6">
                                                <div class="card-body">
                                                    <h6 class="textHeaderTitle">
                                                        <img src="https://underconstruction.mywebapp.online/assets/images/avatar_nzuzi_default.png" alt="" width="60" height="60" class="img_icons_3 zoomIn animated">
                                                    ...
                                                    @foreach ($sub_services_1 as $sub1)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @foreach ($subservices as $sub)
                                                            <div class="col-md-6">
                                                                <a href="{{ route('user.basiclistingbusinesssub2',['service_id'=> encrypt($ser->id),'sub_service_id'=> encrypt($sub->id),'sub_service_one_id'=> encrypt($sub1->id)]) }}" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $sub->sub_service_name }} (0)">
                                                                    <div class="mb-1">
                                                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                                                       {{ \Illuminate\Support\Str::limit($sub->sub_service_name, 16) }}
                                                                    <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                                                    </div>
                                                                </a>
                                                            </div>
