                                    ...
                                    <div class="card-body" style="-7px">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-4">
                                                <a href="{{ route('user.viewcountryproducts',['country_id' => encrypt($c->country_id)]) }}"> <img
                ...
                <div class="mb-5 col-lg-8 mb-lg-0">
                    ...
                    <div class="card card5">
                        <div class="card-header"
                            style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                            <div class="row">
                                <div class="col-11"><i class="fa fa-tags"></i> Products on Sale <span
                                        class="counter badge_3" data-target="49">0</span> </div>
                        ...
                        <div class="card-body">
                            <div class="card">
                                <div class="card-body">
                                    <p style="background-color:#FFF; margin-top:10px; margin-right:20px;" align="right">
                                        <font color="#FF7519"><b>Order Step 1</b> of 3</font>
                                    </p>
                                    <div class="py-2 my-2"
                                        ...
                                        <p style="bacground-color:#fcf8e3;color:8a6d3b;font: 10pt/130% Helvetica, Arial, sans-serif;margin-left:1%;margin-right:1%"
                                            align="center">
                                            Easily find the products you need among the thousands of products available
                                            by using the search engine at the top of the order page or the category tree
                                            on the left. Then use the filters on your left to choose your brand, colors
                                            and price and then click on <a>ORDER NOW! Button</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="table-data_product">
                                    <div class="row g-1" id="dynamic_content_product">
                                        <div id="load_data"></div>
                                        @forelse($products as $row)

                                        <div
                                            class="col-md-3 col-6 d-flex justify-content-center fade_in u-fade-type-left js-scroll-trigger">
                        ...
                        <div class="mb-3 card card6">
                            ...
                            <div class="card-body" style="margin-left:-10px">
                                <ul class="gap-2 d-grid listitems"
                                    ...
                                    <li>Table PC&nbsp;&nbsp;<span style="color:#FF7519;font-weight:bolder">1</span>
                                    </li>
