                            ...
                            <div class="row">
                                ...
                                <div class="col-11">
                                    ...
                                    <i class="{{ $m->service_image }}" style="font-size: 1.3rem;color:#FF7519;"
                                         height="40"
                                        width="40"></i>
                                       <span style="color:#FFF;">{{ $m->service_name }}</span>  <font color="#ff7519">&nbsp;&nbsp;» </font>
                                      ...
                                      <font color="#ff7519">&nbsp;&nbsp;» </font>
                                       <a href="#" class="hrefCss3s" style="color:#FF7519">@foreach ($subservice_name as $row1)   {{ $row1->sub_service_name }}  @endforeach </a>
                    ...
                    <div class="card-body">
                                                ...
                                                <div class="col-md-8">
                                                   ...
                                                   <font color="#8a6d3b" class="py-2"><i
                                                           ...
                                                           style="font-size:1.9rem"></i> <b>POST STEP <font
                                                               color="#FF7519"><b>3</b></font></b> <b>OF 3</b>
                                                   </font>
                                                   @endforeach
                                               </p>
                                                </div>
                        ...
                        <form id="form-id" enctype="multipart/form-data">
                              @foreach ($getbusinessdata as $user)
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control department" id="department" name="department"  value="{{ $user->department }}"
                                ...
                                <div class="row">
                                    <div class="mt-0 col-md-6">
                                        ...
                                        <label style="color:#666"><font color="red">*</font> @foreach ($subservice_name as $row1)   {{ $row1->sub_service_name }}  @endforeach Name</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control company_name" name="company_name" placeholder="@foreach ($subservice_name as $row1){{ $row1->sub_service_name }}@endforeach Name">
                                        </div>
                                        <span class="text-danger">
                                ...
                                <div class="mt-3 row">
                                    <div class="mt-0 col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="color" class="form-control company_color2" id="company_color2" name="company_color2" style="height: 40px;">
                                        </div>
                                        <span class="text-danger">
                                            <strong id="company_colors-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                          </span>
                                    </div>
                                    <div class="mt-0 col-md-6">
                                        <label style="color:#666">Banner Title Color</label>
                                        <div class="form-group">
                                            <input type="color" class="form-control company_title_color2" id="company_title_color2" name="company_title_color2" style="height: 40px;">
                                        </div>
                                        <span class="text-danger">
                                            <strong id="company_title_color2-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                          </span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mt-1 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control map_location" id="maploc" placeholder="Map Location"  name="map_location">
                                            <span class="text-danger">
                                                <strong id="maploc-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                             ...
                             <div class="mt-3 mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                          <input type="hidden" name="sub_service_1_id" value="@foreach ($sub_service_1_id as $s1){{ $s1->id }}@endforeach">
                                          <input type="hidden" name="sub_service_2_id" value="@foreach ($sub_service_2_id as $s2){{ $s2->id }}@endforeach">
                                          <input type="hidden" name="sub_service_3_id" value="@foreach ($sub_service_3_id as $s3){{ $s3->id }}@endforeach">
                                          <input type="hidden" name="sub_service_id" value="@foreach ($subservice_name as $ss){{ $ss->id }}@endforeach">
                                          <input type="hidden" name="service_id" value="@foreach ($servicesid as $mm){{ $mm->id }}@endforeach">
                                        ...
                                        <button type="button" class="mt-3 btn-basiclisting-business btn btn-outline btn-lg w-100 DetailsBtns2_">
