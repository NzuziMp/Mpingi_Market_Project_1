                ...
                <div class="mb-4 col-md-7 mb-lg-0">
                    ...
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                <div class="col-11"><i class="fa fa-user"></i> Change password
                                </div>
                           ...
                           <div class="row">
                              <div class="col-md-3"></div>
                               <div class="col-md-6">
                                ...
                                <div class="text-center alert alert-warning titleDetails" role="alert">
                                ...
                                <form method="POST" action="#">
                                    ...
                                    <div class="mb-3 input-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="oldpassword" id="myInput1"  placeholder="Old Password"
                                                aria-label="NPassword" aria-describedby="basic-addon1" autocomplete="off">
                                    ...
                                    <div class="mb-3 input-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="newpassword" id="myInput2"  placeholder="New Password"
                                                aria-label="OPassword" aria-describedby="basic-addon1" autocomplete="off">
                                    ...
                                    <div class="mb-3 input-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="confirmpassword" id="myInput1"  placeholder="Confirm Password"
                                                aria-label="CPassword" aria-describedby="basic-addon1" autocomplete="off">
