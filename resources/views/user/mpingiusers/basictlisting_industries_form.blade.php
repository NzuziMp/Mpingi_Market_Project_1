                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-11">
                                        ...
                                        <i class="fa fa-industry" style="font-size: 1.3rem"
                                             height="40"
                                            width="40"></i>
                                            @foreach ($mainindustries as $main)
                                                 {{ $main->industry_name }}
                                            @endforeach
                                        <font color="#ff7519">&nbsp;&nbsp;» </font>
                                        <a href="#" class="hrefCss3s" style="color:rgb(255, 117, 25)">@foreach ($fetchallIndustriessubcat as $w){{ $w->sub_industry_name }}  @endforeach</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-1">
                           ...
                           <div class="mt-3 row">
                                    <p style="font: 12pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold">1- Provide your company details&nbsp;</p>
                                    <hr>
                                </div>
                             <div class="mt-3 row">
                              ...
                              @foreach ($getbusinessdata as $user)
                                ...
                                <div class="row">
                                    <div class="mt-0 col-md-6">
                                        ...
                                        <label style="color:#666"><font color="red">*</font> Company Name</label>
                                        <div class="form-group">
                                ...
                                <div class="mt-3 row">
                                    <p style="font: 12pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold">2- Position your company&nbsp;</p>
                                    <hr>
                                </div>
                                ...
                                <div class="row">
                                    <div class="mt-1 col-md-6">
                                        <div class="form-group">
                                             <span
                                                style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none">
                                                2.1- In which year was your company established?
                                            </span> <font color="red">*</font>
                                            <div class="form-group">
                                                <input type="text" class="form-control question_1" name="question_1"  placeholder="In what year was your company established?">
                                            </div>
                                            <span class="text-danger">
                                                <strong id="question_1-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                        </div>
                                    </div>
                                    <div class="mt-1 col-md-6">
                                        <div class="form-group">
                                            <span
                                            style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none">
                                            2.2- How many employees are located at this facility?
                                        </span> <font color="red">*</font>
                                            <div class="form-group">
                                                <input type="text" class="form-control question_2" name="question_2"  placeholder="How many employees are located at this facility?">
                                            </div>
                                            <span class="text-danger">
                                                <strong id="question_2-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="mt-1 col-md-6">
                                        <div class="form-group">
                                             <span
                                                style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none">
                                                2.3- What is your overall sales? (in millions)
                                            </span> <font color="red">*</font>
                                            <div class="form-group">
                                                <input type="text" class="form-control question_3" name="question_3"  placeholder="How many employees are located at this facility?">
                                            </div>
                                            <span class="text-danger">
                                                <strong id="question_3-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                        </div>
                                    </div>
                                    <div class="mt-1 col-md-6">
                                        <div class="form-group">
                                            <span
                                            style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none">
                                            2.4- Please specify company certifications (ISO9000, QS9000, etc)
                                        </span> <font color="red">*</font>
                                            <div class="form-group">
                                                <input type="text" class="form-control question_4" name="question_4"  placeholder="How many employees are located at this facility?">
                                            </div>
                                            <span class="text-danger">
                                                <strong id="question_4-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 row">
                                    <div class="mt-1 col-md-6">
                                        <div class="form-group">
                                             <span
                                                style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none">
                                                2.5- Is this a minority owned business?
                                            </span> <font color="red">*</font>
                                            <div class="mt-3 row g-1">
                                                <div class="col-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="question_5" value="African" id="flexRadioDefault1">
                                                ...
                                                <div class="col-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="question_5" value="African American" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                            American
                                                        </label>
                                                      </div>
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="question_5" value="Asian-Pacific American" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        Asian
                                                    </label>
                                                  </div>
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="question_5" value="Service Disabled Veteran" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="question_5" value="Veteran" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        Veteran
                                                    </label>
                                                  </div>
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="question_5" value="Woman" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        Woman
                                                    </label>
                                                  </div>
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="question_5" value="HUBzone" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        HUBzone
                                                    </label>
                                                  </div>
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="question_5" value="SBA 8(a)" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        SBA 8(a)
                                                    </label>
                                                  </div>
                                            ...
                                            <span class="text-danger">
                                                <strong id="question_5-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                    ...
                                    <div class="mt-1 col-md-6">
                                        <div class="form-group">
                                            <span
                                            style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none">
                                            2.6- Does your company accept export orders?
                                          </span> <font color="red">*</font>
                                        </div>

                                        <div class="mt-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="question_6" value="Africa" id="defaultCheck1">
                                     ...
                                     <div class="">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="question_6" value="America" id="defaultCheck1">
                                        <label class="form-check-label" for="defaultCheck1">
                                            America
                                        </label>
                                        </div>
                                      ...
                                      <div class="">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="question_6" value="Asia" id="defaultCheck1">
                                            <label class="form-check-label" for="defaultCheck1">
                                                Asia
                                            </label>
                                            </div>
                                        ...
                                        <div class="">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="question_6" value="Europe" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    Europe
                                                </label>
                                                </div>
                                            ...
                                            <span class="text-danger">
                                                <strong id="question_6-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 row">
                                    <p style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#FF7519;font-weight:bold">2.7- Please specify the appropriate person's name and title for the following functions in your company:&nbsp;</p>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-1 mt-2"> <label>
                                                        <font color="red">*</font> <span
                                                        style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none"> No President
                                                        </span>
                                                    </label>&nbsp;</div>
                                                <div class="flex-1 mt-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="checkWebsitepName">
                                                    </div>
                                                </div>
                                            </div>


                                            <input type="text" class="form-control president" id="pname" name="president"  value=""
                                                placeholder="President Name">
                                           <span class="text-danger">
                                             <strong id="president-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-1 mt-2"> <label>
                                                        <font color="red">*</font> <span
                                                        style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none"> No Purchasing
                                                        </span>
                                                    </label>&nbsp;</div>
                                                <div class="flex-1 mt-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="checkPurchaseName">
                                                    </div>
                                                </div>
                                            </div>


                                            <input type="text" class="form-control purchasing" id="purchasing_name" name="purchasing" value=""
                                                placeholder="Purchasing Name">
                                            <span class="text-danger">
                                                <strong id="purchasing-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-1 mt-2"> <label>
                                                        <font color="red">*</font> <span
                                                        style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none"> No Advertising
                                                        </span>
                                                    </label>&nbsp;</div>
                                                <div class="flex-1 mt-2">
                                                    <div class="form-check">
                                            ...
                                            <input type="text" class="form-control advertising" id="advertising_name" name="advertising"  value=""
                                                placeholder="Advertising Name">
                                           <span class="text-danger">
                                             <strong id="advertising-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-1 mt-2"> <label>
                                                        <font color="red">*</font> <span
                                                        style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none"> No Marketing
                                                        </span>
                                                    </label>&nbsp;</div>
                                                <div class="flex-1 mt-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="checkMarketingName">
                                                    </div>
                                                </div>
                                            </div>


                                            <input type="text" class="form-control marketing" id="marketing_name" name="marketing" value=""
                                                placeholder="Marketing Name">
                                            <span class="text-danger">
                                                <strong id="marketing-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-1 mt-2"> <label>
                                                        <font color="red">*</font> <span
                                                        style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none"> No Sales
                                                        </span>
                                                    </label>&nbsp;</div>
                                                <div class="flex-1 mt-2">
                                                    <div class="form-check">
                                            ...
                                            <input type="text" class="form-control sales" id="sales_name" name="sales"  value=""
                                                placeholder="Sales Name">
                                           <span class="text-danger">
                                             <strong id="sales-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-1 mt-2"> <label>
                                                        <font color="red">*</font> <span
                                                        style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold;pointer-events: none"> No Engineering
                                                        </span>
                                                    </label>&nbsp;</div>
                                                <div class="flex-1 mt-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="checkEngineeringName">
                                                    </div>
                                                </div>
                                            </div>


                                            <input type="text" class="form-control engineering" id="engineering_name" name="engineering" value=""
                                                placeholder="Engineering Name">
                                            <span class="text-danger">
                                                <strong id="engineering-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mt-2 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control map_location_industry" id="maplocation" placeholder="Map Location"  name="map_location_industry">
                                            <span class="text-danger">
                                                <strong id="map_location_industry-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                              <span style="font-style:italic;font-size:12px;color:#666"> Please visit here <a href="https://www.maps.ie/create-google-map/" target="_blank" style="color:#f25433;text-decoration:none">https://www.maps.ie/create-google-map/</a> then Enter Your Settings, after copy below the gerarated code from <font color="orange">Copy your iFrame code</font> note!: you can only copy is inside a <b>src="copy code here" </b>not whole code or iframe, then paste the code into a input field</span>
                             ...
                             <div class="mt-3 mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                          ...
                                          <input type="hidden" name="industry_id" value="@foreach ($mainindustries as $main){{ $main->id }}@endforeach">
                                          <input type="hidden" name="sub_industry_id" value="@foreach ($fetchallIndustriessubcat as $w){{ $w->id }}  @endforeach">

                                          <input type="hidden" name="ad_type" value="0">
                                        <button type="button" class="mt-3 btn-basiclistingindustries btn btn-outline btn-lg w-100 DetailsBtns2_">
