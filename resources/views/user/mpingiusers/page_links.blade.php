                ...
                <div class="mb-4 col-md-7 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                <div class="col-11"><i class="fa fa-link"></i> My Links Account (Social Media)
                                </div>
                         ...
                         {{--end alert update profile and business account  --}}
                            ...
                            <div class="mt-3 card-body" style="background-color:#fcf8e3;color:#8a6d3b" align="left">
                                ...
                                <p class=""
                                    ...
                                    empty
                                    here<br><Br>
                                    <i class="fa fa-link" style="font-size:1.3rem;"></i> Please copy and paste your social media link exactly e.g.
                                    (https://www.facebook.com/mpingi/)
                                </p>
                        ...
                        <form id="form-link" method="POST">
                            <div class="mt-3 row">
                                {{-- <p
                                    style="font: 11pt/130% Helvetica, Arial, sans-serif;color:#666;font-weight:bold"><i
                                        class="fa fa-shopping-basket"></i></p> --}}
                                <div class="mt-3 col-md-12">
                                    <div class="form-group">
                                        <label for="" style="font-weight:bold;color:#666;font-size:0.8rem">
                                            <font color="red">*</font> Website on www.mpingimarket.com
                                        </label>
                                        <div class="mt-2 row g-0">
                                            <div class="col-1">
                                                <i class="fa fa-globe" style="color:#2daae1;font-size:35px;"></i>&nbsp;&nbsp;
                                            </div>

                                            <div class="col-11">
                                                <input type="text" class="form-control" id="edit_website_name" name="website_name" value="{{ $link->website_name }}"
                                                    placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-3 col-md-12">
                                    <div class="form-group">
                                        <label for="" style="font-weight:bold;color:#666;font-size:0.8rem">
                                            <font color="red">*</font> Page Link on www.mpingimarket.com
                                        </label>
                                        <div class="mt-2 row g-0">
                                            <div class="col-1">
                                                <i class="fa fa-link" style="color:#3b5998;font-size:35px;"></i>&nbsp;&nbsp;
                                            </div>

                                            <div class="col-11">
                                                <input type="text" class="form-control" placeholder="" id="edit_website_link" name="website_link" value="{{ $link->website_link }}"
                                                    value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-1 mt-2">
                                                <label for=""
                                                    style="font-weight:bold;color:rgb(102, 102, 102);font-size:0.8rem">
                                                    <font color="red">*</font> No Facebook Link
                                                </label>&nbsp;
                                            </div>
                                            <div class="flex-1 mt-2">
                                        ...
                                        <div class="mt-2 row g-0">
                                            <div class="col-1">
                                                ...
                                                <i class="fab fa-facebook-square"
                                                    style="color:#3b5998;font-size:35px;"></i>
                                            </div>

                                            <div class="col-11">
                                                <input type="text" class="form-control" id="edit_facebook_link" name="facebook_link" value="{{ $link->facebook_link }}"
                                                    placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-1 mt-2">
                                                <label for=""
                                                    style="font-weight:bold;color:#666;font-size:0.8rem">
                                                    <font color="red">*</font> No Twitter Link
                                                </label>&nbsp;
                                            </div>
                                            <div class="flex-1 mt-2">
                                                <div class="form-check">
                                        ...
                                        <div class="mt-2 row g-0">
                                            <div class="col-1">
                                                ...
                                                <i class="fab fa-twitter-square"
                                                    style="color:#2daae1;font-size:35px;"></i>
                                            </div>

                                            <div class="col-11">
                                                <input type="text" class="form-control" id="edit_twitter_link" name="twitter_link" value="{{ $link->twitter_link }}"
                                                    placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-1 mt-2">
                                                <label for=""
                                                    style="font-weight:bold;color:#666;font-size:0.8rem">
                                                    <font color="red">*</font> No Youtube Link
                                                </label>&nbsp;
                                            </div>
                                            <div class="flex-1 mt-2">
                                                <div class="form-check">
                                        ...
                                        <div class="mt-2 row g-0">
                                            <div class="col-1">
                                                ...
                                                <i class="fab fa-youtube-square"
                                                    style="color:#ff3132;font-size:35px;"></i>
                                            </div>

                                            <div class="col-11">
                                                <input type="text" class="form-control" id="edit_youtube_link" name="youtube_link" value="{{ $link->youtube_link }}" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-1 mt-2">
                                                <label for=""
                                                    style="font-weight:bold;color:#666;font-size:0.8rem">
                                                    <font color="red">*</font> No Instagram Link
                                                </label>&nbsp;
                                            </div>
                                            <div class="flex-1 mt-2">
                                                <div class="form-check">
                                        ...
                                        <div class="mt-2 row g-0">
                                            <div class="col-1">
                                                ...
                                                <i class="fab fa-instagram-square"
                                                    style="color:#b18a6e;font-size:35px;"></i>
                                            </div>

                                            <div class="col-11">
                                                <input type="text" class="form-control" id="edit_instagram_link" name="instagram_link" value="{{ $link->instagram_link }}"
                                                    placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-1 mt-2">
                                                <label for=""
                                                    style="font-weight:bold;color:#666;font-size:0.8rem">
                                                    <font color="red">*</font> No Location Map
                                                </label>&nbsp;
                                            </div>
                                            <div class="flex-1 mt-2">
                                                <div class="form-check">
                                        ...
                                        <div class="mt-2 row g-0">
                                            <div class="col-1">
                                                ...
                                                <i class="fas fa-map-marker-alt"
                                                    style="color:#189d0e;font-size:35px;"></i>
                                            </div>

                                            <div class="col-11">
                                                <input type="text" class="form-control" id="edit_map_link" name="map_link" value="{{ $link->map_link }}"
                                                    placeholder="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mt-3 row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                         <input type="hidden" name="id" id="edit_id" value="{{ $link->id }}">
                                        <button type="submit" class="mt-3 btn btn-outline btn-lg btn-editsociallink w-100 DetailsBtns2_">
                                            Update Your Social Media Link</button>
                        ...
                        @empty
                         ...
                         <form id="form-link" method="POST">
                                ...
                                <div class="mt-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="mt-2 row g-0">
                                            ...
                                            <div class="col-11">
                                                <input type="text" class="form-control" placeholder="" id="website_link" name="website_link"
                                                    value="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mt-3 row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        @foreach ($getuserlinks as $r)
                                         <input type="hidden" name="id" id="id" value="{{ $r->id }}">
                                        @endforeach
                                        <button type="submit" class="mt-3 btn btn-outline btn-lg w-100  btn-userlinks DetailsBtns2_">
                                            Update Your Social Media Link</button>
