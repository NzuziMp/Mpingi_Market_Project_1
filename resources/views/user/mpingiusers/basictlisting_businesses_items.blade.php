                    ...
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                <div class="col-10"><i class="fa fa-briefcase"></i> <span class="counter"
                                        data-target="0">0</span> {{ $availjobs->job_category_name }}</div>
                        ...
                        <div class="card-body">
                          ...
                          {{--  --}}
                            ...
                            <p class="textPCss" align="center">No {{ $availjobs->job_category_name }} Posted</p>
                            <div id="submit_compare2" align="center" style="padding-bottom:10px"><a data-toggle="modal" href="#login1" id="pic" title="Change picture" class="top44" style="font: 10pt/130% Helvetica, Arial, sans-serif;font-weight:bold; color:#fff"><i class="fa fa-plus-square"></i> Post {{ $availjobs->job_category_name }}  for free Now!</a></div>
