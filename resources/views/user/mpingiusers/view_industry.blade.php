    ...
    <section class="py-2 border-bottom " id="features">
        <div class="container-fluid">
            ...
            <div class="row g-1">
                ...
                <div class="mb-4 col-md-8 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                @foreach ($countIndustryItems as $rowc)
                                <div class="col-11"><i class="fa fa-industry"></i> My Industries <span
                                ...
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#ff7519;color:#ffffff">
                                        <div class="py-4 card-body">
                                           @php
                                             $countIndustryItemsFree = DB::table('tbl_industry_items')->where(['user_id' => Auth::user()->id, 'ad_type' => 0, 'expire_status' => 1])->count();
                                           @endphp
                                            <h3 align="center">{{ $countIndustryItemsFree }} Free <br>Industries </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#ffd900;color:#ffffff">
                                        <div class="py-4 card-body">
                                            @php
                                             $countIndustryItemsPaid = DB::table('tbl_industry_items')->where(['user_id' => Auth::user()->id, 'ad_type' => 1, 'expire_status' => 1])->count();
                                            @endphp
                                            <h3 align="center">{{ $countIndustryItemsPaid }} Paid <br>Industries </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#5a88ca;color:#ffffff">
                                        <div class="py-4 card-body">
                                            @php
                                            $countIndustryItemsExpired = DB::table('tbl_industry_items')->where(['user_id' => Auth::user()->id,'expire_status' => 0])->count();
                                           @endphp
                                            <h3 align="center">{{  $countIndustryItemsExpired }} Expired <br>Industries </h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                @foreach ($countIndustryItems as $rowc)
                                <div class="col-11"><i class="fa fa-industry"></i> My Industries (items) <span
                                    class="badge_3">{{ $rowc->cnt }}</span>
                                </div>
                                @endforeach
                                {{-- <div class="col-1"><i class="fa fa-times text-dark close-icon6"></i></div> --}}
                     ...
                     <div class="card-body">
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0" class="table industriesitem-datatable" style="border-bottom: 0;border-top: 0;border-style:none">
                               <tbody>
                                    {{-- call server side ajax to controllers --}}
                              </tbody>
                            </table>
                         </div>
                     </div>
                ...
                @include('user.modal.uploadindustrylogoModal')
                @include('user.modal.updatepriceModal')
                {{--all right content --}}
                <div class="col-lg-2">
