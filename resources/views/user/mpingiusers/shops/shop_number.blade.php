...
<body class="flexcroll">
    <div class="topnav">
        <nav class="navbar navbar-light my-navbarCss" style="background-color:#464444;border-bottom: 2px solid #f24c15">
            <div class="container">
                <a class="navbar-brand" href="/"><img src="{{ asset('assets/images/mpingi market logo 125 46 gh.png') }}" style="width: 16rem"
                            ...
                            <div class="carousel-inner shopCss">
                                <div class="carousel-item active top_shop">
                                    ...
                                    <h1 class="">
                                        ...
                                        {{ \Illuminate\Support\Str::upper(Str::limit($shops->business_name,23))}}
