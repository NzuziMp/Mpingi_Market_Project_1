            ...
            <div class="row g-1">
                ...
                <div class="mb-4 col-md-8 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header" style="background-color:#5a88ca;color:#fff;font-weight:bold">
                            <div class="py-2 row">
                                <div class="col-11">
                                    <h3><i class="fas fa-gift"></i> My Sale products ({{ $countmyPostpurchases }})</h3>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            {{-- --}}
                                <div class="table-responsive">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table mysalesproducts-datatable" style="border-bottom: 0;border-top: 0;border-style:none">
                                    <tbody>
                        ...
                        @include('user.modal.showbuyerModal')
                            {{-- --}}
                        </div>
                    </div>
