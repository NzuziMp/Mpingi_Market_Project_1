                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @foreach ($fetchallindustries as $industry)
                                                            <div class="col-md-6">
                                                                <a href="{{ route('basiclistingindustriessub',['id'=> encrypt($industry->id)]) }}" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $industry->industry_name }} (0)">
                                                                    <div class="mb-1">
                                                    ...
                                                    <h6 class="textHeaderTitle">
                                                      ...
                                                      {{--  --}}
                                                        @foreach ($fetchallIndustriessubcat as $rowsub)
                                                          <div class="col-md-6">
                                                            <a href="{{ route('basiclistingindustriessubID',['sub_id'=> encrypt($rowsub->id),'main_id'=> encrypt($m->id)]) }}" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $rowsub->sub_industry_name }}">
                                                                <div class="mb-1">
                                                                    <i class="fas fa-bullseye" style="font-size:8px"></i>
