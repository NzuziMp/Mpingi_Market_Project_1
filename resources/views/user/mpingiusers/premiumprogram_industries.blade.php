                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                @foreach ($mainindustries as $m)

                                    <div class="col-11">

                                        <i class="fa fa-cogs" style="font-size: 1.3rem"
                                             height="40"
                                            width="40"></i>
                                            {{ $m->industry_name }}
                                        ...
                                        <div class="mb-4 col-lg-6 mb-lg-0">
                                            <div class="mb-3 card card6">
                                                <div class="card-header"
                                                    style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                                                    <div class="row">
                                                        <div class="col-11"><i class="fa fa-list"></i> SERVICE CATEGORIES
                                                        </div>
                                                        {{-- <div class="col-1"><i class="fa fa-times text-dark close-icon6"></i></div> --}}
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        {{--  --}}
                                                        @foreach ($fetchallindustries as $industry)
                                                            <div class="col-md-6">
                                                                <a href="{{ route('premiumprogramindustriessub',['id'=> encrypt($industry->id)]) }}" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $industry->industry_name }} (0)">
                                                                    <div class="mb-1">
                                                                        <i class="fas fa-bullseye" style="font-size:8px"></i>
                                                                       {{ \Illuminate\Support\Str::limit($industry->industry_name, 16) }}
                                                                    <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                                                    </div>
                                                                </a>
                                                            </div>
                                        ...
                                        <div class="mb-4 col-lg-6 mb-lg-0">
                                            <div class="mb-3 card card6">
                                                <div class="card-header"
                                                    ...
                                                    <div class="row">
                                                        @foreach ($mainindustries as $m)
                                                          <div class="col-11"><i class="fa fa-cogs" style="font-size: 0.9rem"></i> {{ $m->industry_name }}</div>
                                                        @endforeach
                                                        {{-- <div class="col-1"><i class="fa fa-times text-dark close-icon6"></i></div> --}}
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    ...
                                                    <h6 class="textHeaderTitle">
                                                      ...
                                                      <div class="row">
                                                      {{--  --}}
                                                        @foreach ($fetchallIndustriessubcat as $rowsub)
                                                          <div class="col-md-6">
                                                            <a href="{{ route('premiumprogramindustriessubID',['sub_id'=> encrypt($rowsub->id),'main_id'=> encrypt($m->id)]) }}" class="removeU" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $rowsub->sub_industry_name }}">
                                                                <div class="mb-1">
                                                                    <i class="fas fa-bullseye" style="font-size:8px"></i>
                                                                    {{ \Illuminate\Support\Str::limit($rowsub->sub_industry_name, 16) }}
                                                                    @foreach($countsubindustry as $s)
                                                                    {{-- {{ $ss->id }} --}}
                                                                       @if($s->sub_industry_id == $rowsub->id)
                                                                        <span class="badge_3">({{ $s->subindustry_cnt }}) </span>
                                                                       @else
                                                                       {{-- <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span> --}}
                                                                       @endif
                                                                       @endforeach
