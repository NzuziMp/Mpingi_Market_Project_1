            ...
            <div class="row g-1">
                ...
                <div class="mb-4 col-md-9 mb-lg-0">
                    <div class="mb-3 card card6">
                        ...
                        @foreach ($fetchAllJobsItems as $user)
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control inputCss" id="department" value="{{ $user->department }}" placeholder="" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="job_title" value="{{ $user->job_title }}" placeholder="" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mt-2 form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $user->company_name }}" placeholder="" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="2" id="business_description" class="form-control"
                                            placeholder="" readonly> {!!  html_entity_decode($user->job_description) !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <p class="mt-4" style="font-size:13px;font-weight: bold;color:#666;">1.2- Set location
                                ...
                                <div class="row g-1">
                                    ...
                                    <div class="col-md-3">
                                        <font color="red">*</font>
                                         <select class="form-select form-selects place_of_origin" name="place_of_origin" value="{{ $data->countryname }}" aria-label="Default select example" style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666" readonly>
                                    ...
                                    <div class="col-md-3">
                                        <font color="red">*</font>
                                        <select class="form-select form-selects city" name="city" value="{{ $data->cityname }}" aria-label="Default select example" style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;" readonly>
                                    ...
                                    <div class="col-md-3">
                                        <font color="red">*</font>
                                        <select class="form-select form-selects state_id" name="state_id" value="{{ $data->statename }}" aria-label="Default select example" style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;" readonly>
                            ...
                            <div class="mt-2 row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="po_box" placeholder="" value="{{ $user->p_box }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="2" class="form-control"
                                            placeholder="" readonly>{{ $user->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mt-2 form-group">
                                        ...
                                        <input type="text" class="form-control " placeholder="" value="{{ $user->phone }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email_address" placeholder="" value="{{ $user->email }}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mt-2 form-group">
                                        ...
                                        <input type="text" class="form-control " placeholder="" value="{{ $user->mobile }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="website" placeholder="" value="{{ $user->website }}" readonly>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{-- <button type="button" class="mt-3 btn btn-outline btn-lg w-100 DetailsBtns2_">
