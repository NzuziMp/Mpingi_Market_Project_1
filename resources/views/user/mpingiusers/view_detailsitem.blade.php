                                            ...
                                            <div class="card">
                                                ...
                                                @forelse ($getimageid as $row)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <h6 class="mt-1 card-title fw-bold current_nzuzi_mping__"> {{ $row->currency }} {{ number_format($row->price,2) }} <br>   <strike class="current_nzuzi_mping_"> {{ $row->currency }} {{ number_format($row->old_price) }}</strike></h6>
                                                        ...
                                                        <div>
                                                            {{-- <h4 class="text-center">
                                                                <i class="mr-1 fas fa-star star-light submit_star" id="submit_star_1" data-rating="1"></i>
                                                                <i class="mr-1 fas fa-star star-light submit_star" id="submit_star_2" data-rating="2"></i>
                                                                <i class="mr-1 fas fa-star star-light submit_star" id="submit_star_3" data-rating="3"></i>
                                                                <i class="mr-1 fas fa-star star-light submit_star" id="submit_star_4" data-rating="4"></i>
                                                                <i class="mr-1 fas fa-star star-light submit_star" id="submit_star_5" data-rating="5"></i>
                                                            </h4> --}}



                                                            <span>
                                                                <a href="{{ route('user.itemdetailsbuy', ['upload_id' => encrypt($row->id), 'product_id' =>encrypt($row->product_id)]) }}"><button type="button"
                                                            ...
                                                            {{-- <span data-bs-toggle="modal"
                                                                data-bs-target="#login_Modal"> <button type="button"
                                                                    ...
                                                                    data-bs-target="#sellerbuyer_Modal"> <button type="button"
                                                                        ...
                                                                        class="mt-3 mb-3 btn btn-outline w-100 DetailsBtn">
                                                                       ...
                                                                       <center>
                                                                        <span style="text-align: center;">
                                                                            ...
                                                                            @if ($row->islogged === "Online")
                                                                               <span style="color: #666;">Online: </span><img src="{{asset('assets/images/online.png')}}" alt="">
                                                                            @else
                                                                               <span style="color: #666;">Offline: </span><img src="{{asset('assets/images/off.png')}}" alt="">
                                                                            @endif

                                                                            |

                                                                            @if ($row->islogged === "Online")
                                                                            <a href="{{ route('user.online') }}" class="homecontent_details2_x"
                                                                            style="font-size:2.6vmin;"><i class='fa fa-comments' style="color: #666;" style="color: #666"></i> <span style="color: #666;" style="color: #666">
                                                                                Chat now!</span>
                                                                            </a>
                                                                            @else
                                                                            <i class='fa fa-envelope' data-bs-toggle="modal" style="color: #666"
                                                                            data-bs-target="#chatnow_Modal"></i> <span style="color: #666;" data-bs-toggle="modal" style="color: #666"
                                                                            data-bs-target="#chatnow_Modal">
                                                                            Leave a message</span>
                                                                            @endif

                                                                            </span>
                                                                       </center>
                                                                            @include('user.modal.chatnowModal')
                                                ...
                                                <div class="card-body">
                                                    <form method="POST" id="forms-id">
                                                        <input type="hidden" name="rate" id="rate" value="{{ $row3->product_id }}">
                                                              ...
                                                              <button type="button"
                                                                            class="mt-2 btn-rate1 btn btn-outline w-100 DetailsBtn">
                                                                         Rate!</button>
                                                             </form>
                                                      {{-- <div class="form-check">
                                                        <input class="form-check-input negotiable"  value="1" name="rating"  type="radio" >
                                                      ...
                                                      <button type="button"
                                                                    class="mt-2 btn btn-outline w-100 DetailsBtn">
                                                                 Rate!</button> --}}

                                                  <p  class="mt-4" style="font: 10pt/130% Helvetica, Arial, sans-serif; color:#666;font-weight:bold;pointer-events: none">
                                                     <span>
                                                        <i class="fa fa-truck" style="font-size:1.3rem;color:#1a6be8"></i> Shipping <br><Br>
                                                            1. @if($row3->payment == "Free")
                                                                  Free Shipping
                                                               @elseif($row3->payment == "Home")
                                                                  Home or Office Delivery
                                                               @else
                                                                  Pickup from Shop
                                                               @endif
                                                            <br><Br>
                                                            2. {{ $row3->delivery }} days<br><Br>
                                                         <i class="fa fa-lock" style="font-size:1.3rem;color:#00a61c"></i> Payment<br><br>
                                                            1.{{ $row3->payment }} <br><br>
                                                         <i class="fas fa-sync-alt" style="font-size:1.3rem;color:#f25433"></i> Return policy<br><br>
                                                             Returns accepted within {{ $row3->day_return }} days<br>
                                                    </span>
                                                  </p>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="text-center col-sm-4">
                                                            <h1 class="mt-4 mb-4 text-warning">
                                                                <b><span id="average_rating">0.0</span> / 5</b>
                                                            </h1>
                                                            <div class="mb-3">
                                                                <i class="mr-1 fas fa-star star-light main_star"></i>
                                                                <i class="mr-1 fas fa-star star-light main_star"></i>
                                                                <i class="mr-1 fas fa-star star-light main_star"></i>
                                                                <i class="mr-1 fas fa-star star-light main_star"></i>
                                                                <i class="mr-1 fas fa-star star-light main_star"></i>
                                        ...
                                        <div class="mt-4 row g-1">
                                            <div class="col-md-9">
                                                ...
                                                <div class="card">
                                                    <div class="card-header" style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                                                        <span style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#fff;font-weight:bold"><i
                                                            class="fa fa-envelope"></i> Write Your Review
                                                        </span>
                                                    </div>

                                                    <div class="mx-3 card-body">
                                                        <strong class="mb-3" style="font: 12pt/130% Helvetica, Arial, sans-serif;color:#FF7519;font-weight:bold"><span class="mt-1">Feedback</span> <span class="badge rounded-pill bg-warning">{{ $countFeedback }}</span></strong><br>
                                                    ...
                                                    <div class="card">
                                                            ...
                                                            <div class="mb-2 col-md-12">
                                                                <div class="text-center">
                                                                    <button id="load_more_button" data-page="{{ $messagecomment->currentPage() + 1 }}"
                                                                        class="btn btn-outline-primary">Load More <i class="fa fa-angle-double-right"></i></button>
                                                                </div>
                                                            </div>

                                                        <div class="flex-row p-3 mt-2 d-flex align-items-center">
                                                             @foreach ($getuser as $msg)
                                                                <img src="{{ (!empty($msg->profile)) ? url('/storage/assets/uploads/'.$msg->profile) :  url('/storage/assets/images/deafault_pic.png')}}" width="50" height="50" class="mr-2 rounded-circle">&nbsp;&nbsp;
                                                             @endforeach
                                                                <input type="text" name="message" class="form-control texttyle" placeholder="Message..."
                                                                aria-label="Message" oninput="limitChar2(this)" id="tArea" placeholder="Enter your comment..." autocomplete="off">
                                                         ...
                                                         <div class="mb-4 row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    <input name="profile_user" type="hidden"  value="{{ Auth::user()->profile }}" />
                                                                    <input name="full_name" type="hidden"  value="{{ Auth::user()->first_name }} {{ Auth::user()->middle_name }} {{ Auth::user()->last_name }}" />
                                                                    <input name="user_id" type="hidden"  value="{{ Auth::user()->id }}" />
                                                                    <input name="category_id" type="hidden"  value="{{ $row3->category_id }}" />
                                                                    <input name="sub_category_id" type="hidden" value="{{ $row3->sub_category_id }}" />
                                                                    <input name="article_id" type="hidden"  value="{{ $row3->article_id }}" />
                                                                    <input name="product_id" type="hidden"  value="{{ $row3->product_id }}" />
                                                                    <input name="sub_product_id" type="hidden"  value="{{ $row3->sub_product_id }}" />
                                                                    <input name="item_name" type="hidden"  value="{{ $row3->item_name }}" />
                                                                    <input name="email" type="hidden"  value="{{ $row3->email }}" />
                                                                    <input name="mobile" type="hidden"  value="{{ $row3->mobile }}" />
                                                                    <button type="button" class="btn-submitmessage btn btn-outline btn-lg w-100 DetailsBtns2_"> Write Your Review
                                                                    </button>
                                                                </div>
    ...
    <footer class="mainfooter" role="contentinfo">
        ...
        <script>
            $(document).ready(function() {
                var start = 10;
                var product_id = "{{ $row3->product_id  }}";
                    ...
                    $.ajax({
                        ...
                        beforeSend: function() {
                           var imgs = '<img src="{{ url("/assets/loading/ajax-loader.gif") }}" style="height: 25px; width: 25px;"/>';
                            $('#load_more_button').html(imgs + ' Wait Loading...');
                            $("#load_more_button").prop('disabled', true).addClass("disabled");
                        ...
                        success: function(data) {
                            ...
                            if (data.data.length > 0) {
                                ...
                                for (var i = 0; i < data.data.length; i++) {
                                    ...
                                    <div class="mt-2">
                                            <div class="flex-row p-3 d-flex">
                                                <img src="/storage/assets/uploads/` + data.data[i].profile_user + `" width="40" height="40" class="mr-3 rounded-circle">&nbsp;&nbsp;
                                                <div class="w-100">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="flex-row d-flex align-items-center">
                                                        <span class="mr-2">` + data.data[i].full_name + `</span>
                                                    </div>
                                                    <small>` + moment(data.data[i].message_date, "YYYYMMDD").fromNow() + `</small>
                                                </div>

                                                <p class="mb-0 text-justify comment-text" style="color: #666;">` + data.data[i].message + `</p>
                                            </div>
                                            </div>
                                        </div>
                                        `;
