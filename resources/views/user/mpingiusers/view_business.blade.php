    ...
    <section class="py-2 border-bottom " id="features">
        <div class="container-fluid">
            ...
            <div class="row g-1">
                ...
                <div class="mb-4 col-md-8 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                @foreach ($countServiceItems as $rowc)
                                <div class="col-11"><i class="fa fa-briefcase"></i> My Businesses <span
                                ...
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#ff7519;color:#ffffff">
                                        <div class="py-4 card-body">
                                           @php
                                             $countServiceItemsFree = DB::table('tbl_service_items')->where(['user_id' => Auth::user()->id, 'ad_type' => 0, 'expire_status' => 1])->count();
                                           @endphp
                                            <h3 align="center">{{ $countServiceItemsFree }} Free <br>Businesses </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#ffd900;color:#ffffff">
                                        <div class="py-4 card-body">
                                            @php
                                             $countServiceItemsPaid = DB::table('tbl_service_items')->where(['user_id' => Auth::user()->id, 'ad_type' => 1, 'expire_status' => 1])->count();
                                            @endphp
                                            <h3 align="center">{{ $countServiceItemsPaid }} Paid <br>Businesses </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#5a88ca;color:#ffffff">
                                        <div class="py-4 card-body">
                                            @php
                                            $countServiceItemsExpired = DB::table('tbl_service_items')->where(['user_id' => Auth::user()->id,'expire_status' => 0])->count();
                                           @endphp
                                            <h3 align="center">{{  $countServiceItemsExpired }} Expired <br>Businesses </h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                @foreach ($countServiceItems as $rowc)
                                <div class="col-11"><i class="fa fa-briefcase"></i> My Businesses (items) <span
                                    class="badge_3">{{ $rowc->cnt }}</span>
                                </div>
                                @endforeach
                                {{-- <div class="col-1"><i class="fa fa-times text-dark close-icon6"></i></div> --}}
                     ...
                     <div class="card-body">
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0" class="table businessitem-datatable" style="border-bottom: 0;border-top: 0;border-style:none">
                               <tbody>
                ...
                @include('user.modal.uploadbusinesslogoModal')
