                ...
                <div class="mb-4 col-md-8 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                @foreach ($countProductItems1 as $rowc)
                                <div class="col-11"><i class="fas fa-tags"></i> My Expired Products <span
                            ...
                            <div class="mt-3 row">
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#ff7519;color:#ffffff">
                                        ...
                                        <div class="py-4 card-body">
                                            <h3 align="center">{{ $row->countfree }} Free <br>Products </h3>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#ffd900;color:#ffffff">
                                        @foreach ($paidproducts as $row1)
                                        <div class="py-4 card-body">
                                            <h3 align="center">{{ $row1->countpaid }}  Paid <br>Products </h3>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="mb-2 col-xl-4 col-md-6">
                                    <div class="mb-0 text-white card" style="background-color:#5a88ca;color:#ffffff">
                                        @foreach ($expiredproducts as $row2)
                                        <div class="py-4 card-body">
                                            <h3 align="center">{{ $row2->countexpired }}  Expired <br>Products </h3>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                    ...
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                @foreach ($countProductItems1 as $rowc)
                                <div class="col-11"><i class="fas fa-tags"></i> My Expired Products (items) <span
                                        class="badge_3">{{ $rowc->cnt }}</span>
                                </div>
                                @endforeach
                                {{-- <div class="col-1"><i class="fa fa-times text-dark close-icon6"></i></div> --}}
                     ...
                     <div class="card-body">
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0" class="table productsitem-datatable_Expired" style="border-bottom: 0;border-top: 0;border-style:none">
                               <tbody>
