                    ...
                    <div class="mb-3 card card6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2 row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="address" rows="2" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email_address" name="email" placeholder="" value="{{ $user->email }}">
                                    </div>
                                    <span class="text-danger">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="hidden" name="industry_id" value="@foreach ($getIndustriesItems as $r) {{ $r->id }} @endforeach">
                                        <button type="button" class="mt-3 btn-update-industries btn btn-outline btn-lg w-100 DetailsBtns2_">
