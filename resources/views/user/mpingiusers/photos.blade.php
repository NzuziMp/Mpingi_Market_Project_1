                             ...
                             <form id="form-reset">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <button type="button"  id="removeAll" class="removeAll mt-3 btn btn-outline btn-lg w-100 DetailsBtns2_">
                                               Delete</button>
                                        </div>
                                    </div>
                                    <div class="col-md-2"></div>
                                ...
                                <div class="mt-2 row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                           ...
                                           <a href="{{ route('user.viewpost') }}" class="hrefCss4_"> <button type="button" class="mt-3 btn btn-outline btn-lg w-100 DetailsBtns2_">
                                               Back</button></a>
                                        </div>
                                    </div>
                                    <div class="col-md-2"></div>
