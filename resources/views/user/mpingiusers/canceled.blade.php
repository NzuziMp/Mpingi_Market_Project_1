                    ...
                    <div class="mb-4 col-md-8 mb-lg-0">
                        <div class="mb-3 card card6">
                            <div class="card-header"
                                ...
                                <div class="row">
                                    <div class="col-11"><i class="fas fa-tags"></i>  My Cancel Products   <span  class="badge_3">{{ $countcancelmyOrder }}</span>
                                    </div>
                                    ...
                                    <div class="mb-2 col-xl-4 col-md-6">
                                        <div class="mb-0 text-white card" style="background-color:#ff7519;color:#ffffff">
                                            <div class="py-4 card-body">
                                                <h3 align="center">0 Free <br>Products </h3>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="mb-2 col-xl-4 col-md-6">
                                        <div class="mb-0 text-white card" style="background-color:#ffd900;color:#ffffff">
                                            <div class="py-4 card-body">
                                                <h3 align="center">0 Paid <br>Products </h3>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="mb-2 col-xl-4 col-md-6">
                          ...
                          <div class="mb-3 card card6">
                            <div class="card-header"
                                style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#fff;font-weight:bold">
                                <div class="row">
                                    <div class="col-11"><i class="fas fa-tags"></i>  My Cancel Products (items)  <span  class="badge_3">{{ $countcancelmyOrder }}</span>
                                    </div>
                                    {{-- <div class="col-1"><i class="fa fa-times text-dark close-icon6"></i></div> --}}
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table cellpadding="0" cellspacing="0" border="0" class="table cancelmyorderproducts-datatable" style="border-bottom: 0;border-top: 0;border-style:none">
                                <tbody>
                            ...
                            @include('user.modal.showsellerModal')
                            </div>
