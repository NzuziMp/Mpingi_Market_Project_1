                                ...
                                @foreach ($fetchallCategories as $row)
                                    <div class="accordion-item">
                                        <h6 class="accordion-header" id="headingOne" data-bs-toggle="tooltip"
                                            ...
                                            <form id="form" action="{{ route('user.paidproducts') }}" method="POST">
                                                @csrf
                                                     ...
                                                     <div class="mb-2" data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        <div class="panelx">
                                                         ...
                                                         <p class=""
                                                             ...
                                                             <a href="{{ route('user.paidsubproductid',['id'=> encrypt($rowss->id),'subcategory_id'=> encrypt($data->id),'article_id'=> encrypt($rows->id),'category_id'=> encrypt($row->id),'user_id'=> $user_id, 'ad_type'=> 1]) }}" class="link-secondary sidemenu_a2">
