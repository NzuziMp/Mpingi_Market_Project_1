                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 row">
                                <p style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;;font-weight:bold"><i
                                    class="fa fa-tag" style="font-size:1.3rem;"></i> Product Name: <b>@foreach($productitems as $row4) {{ \Illuminate\Support\Str::title($row4->item_name) }} @endforeach</b>
                                </p>
                                ...
                                <div class="mt-3 card-body" style="background-color:#fcf8e3;color:#8a6d3b" align="left">
                                    ...
                                    <p class=""
                                        ...
                                        <i class="fas fa-exclamation-triangle" style="font-size:1.3rem;"></i> Sorry! Photos already uploaded on this Batteries<br>
                                        <span style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;;font-weight:bold">Please click here to add more photos on this Batteries</span>
                                ...
                                <div class="mt-3 card-body" style="background-color:#fcf8e3;color:#8a6d3b" align="left">
                                    ...
                                    <p class=""
                                        style="text-align:center;bacground-color:#fcf8e3;color:8a6d3b;border:none;font: 10pt/130% Helvetica, Arial, sans-serif">
                                        <i class="fa fa-upload" style="font-size:1.3rem;color:#666"></i> Note that one photo will not be displayed, please upload more than one photos in each products and the images type accepted is <span style="font-weight:bold">.JPG, .PNG, .JPEG, .GIF, .SVG</span>

                                    </p>

                                </div>
                                <form id="form-imgupload"  enctype="multipart/form-data">
                                    <span id="uploadmgs"></span>
                                 <div class="mt-3 row g-3 align-items-center" style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;">
                                    <div class="col-auto">
                                      <label for="inputPassword6" class="col-form-label">Upload Pictures:</label>
                                    </div>
                                    <div class="col-auto">
                                      <input type="file"  class="form-control image_name" id="image_name" name="image_name[]" accept=".png, .jpg, .jpeg, .gif, .svg" aria-describedby="file-upload" multiple>
                                      <span class="text-danger">
                                        <strong id="imguploads-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                        <strong id="imguploads2-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                      </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4"></div>
                                         <div class="col-md-4">
                                            <input type="hidden" name="user_id" value="@foreach($getuser as $row) {{ $row->id }}@endforeach">
                                            <input type="hidden" name="product_item" value="@foreach($productitems as $row4) {{ $row4->id }}@endforeach">
                                            <input type="hidden" name="category_id" value="@foreach($productitems as $row4) {{ $row4->category_id }}@endforeach">
                                            <input type="hidden" name="sub_category_id" value="@foreach($productitems as $row4) {{ $row4->sub_category_id }}@endforeach">
                                            <input type="hidden" name="article_id" value="@foreach($productitems as $row4) {{ $row4->article_id }}@endforeach">
                                            <input type="hidden" name="product_id" value="@foreach($productitems as $row4) {{ $row4->product_id }}@endforeach">
                                            <input type="hidden" name="sub_product_id" value="@foreach($productitems as $row4) {{ $row4->sub_product_id }}@endforeach">
                                            <input type="hidden" name="product_type" value="@foreach($productitems as $row4) {{ $row4->product_type }}@endforeach">
                                            <button type="button" class="mt-3 btn btn-csscolor btn-productitems" id="imageUploadForm"><span class="ladda-label"><i class="fa fa-upload"></i> Upload
                                                Pictures</span></button>
                                         </div>
            ...
            <div class="mb-4 col-md-2 mb-lg-0">
                <div class="mb-3 card card6">
                    ...
                    style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#fff;font-weight:bold">
                      <div class="row">
                           <span><i class="fas fa-image" style="font-size:1.3rem;"></i> Uploaded Pictures</span>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card">
                                ...
                                <div id="myCarousels" class="carousel slide" data-bs-ride="carousel">
                                    <div class="containeroverlay">
                                        <center>
                                            <div class="carousel-inner" >
                                                <div id="preview" style="width: 183px; height: 275px;">
                                                    <img src="{{ asset('/public/assets/uploads/avatar_nzuzi1.png') }}" id="showImage"  height="250px"  width="183" height="275">
