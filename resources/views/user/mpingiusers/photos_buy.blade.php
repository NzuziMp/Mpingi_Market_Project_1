            ...
            <div class="mb-4 col-lg-8 mb-lg-0">
                <div class="mb-3 card card6">
                    <div class="card-header"
                        style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                        <div class="row">
                            <div class="col-11"><i class='far fa-images'></i> View Image
                            </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="mb-2 col-4">
                                      <div class="overflow-hidden" >
                                        <a href="{{ (!empty($row->image_name)) ? url('/storage/assets/uploads', $row->image_name) : url('/storage/assets/images/avatar_nzuzi_default.png')}}" data-fslightbox="gallery" title=""> <img class="w-100 h-100 img-thumbnail" src="{{ '/storage/assets/uploads/'.$row->image_name }}" alt="Card image cap"></a>
                                      </div>
                                  </div>
                                  @empty
                                <center>
