    ...
    <section class="py-2 border-bottom " id="features">
        <div class="container-fluid">
            ...
            <div class="row g-1">
                    ...
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-11"><i class="fa fa-folder"></i> New Messages ({{ $y->count_buyerid }})
                                 </div>
                                 @endforeach
                        ...
                        <div class="card-body">
                         ...
                         {{--end alert update profile and business account  --}}
                            ...
                            <div class="table-responsive">
                                <table cellpadding="0" cellspacing="0" border="0" class="table datatable_pmessage" style="border-bottom: 0;border-top: 0;border-style:none">
                                    <thead>
                                        <tr>
                                            <th scope="col"
                ...
                @include('user.modal.replychatnowModal')
