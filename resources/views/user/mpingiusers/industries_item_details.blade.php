            ...
            <div class="row g-1">
                ...
                <div class="mb-4 col-md-9 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#ff7519;font-weight:bold">
                            @foreach ($getIndustriesItems as $c)
                            <div class="row">
                        ...
                        <div class="card-body">
                            <center>
                                ...
                                @foreach ($getIndustriesItems as $logo)
                            ...
                            @foreach ($fetchAllIndustriesItems as $user)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="2" id="business_description" class="form-control"
                                            placeholder="" readonly> {!!  html_entity_decode($user->description) !!}</textarea>
                                    </div>
                                </div>
                            </div>
