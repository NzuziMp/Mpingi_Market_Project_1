                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body" align="center">
                            <i class="fa fa-check-circle" style="font-size:48px;color:#04AA6D"></i><br>
                            <h5 style="font-size:1rem;color:#666;margin-top:1%">
                                <center><strong>Hello!, John Doe</strong></center>
                            </h5>
                            <p style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666;margin-top:2%">
                                Thank you for ordering. We received you order and will begin processing it soon. Your
                                order informarion appears below.
                            </p>
                            <p style="color:#666;margin-top:1%"><b>Your Order No. </b>10003433</p>
                            <div class="mt-2 row">
                                <div class="col-3"></div>
                                <div class="col-6">
                                    <a href="{{ route('user.purchases') }}" class="hrefCss_3"><button type="button"
