                ...
                <div class="mb-4 col-md-7 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                <div class="col-11"><i class="fa fa-times"></i> Delelte my account
                                </div>
                         ...
                         {{--end alert update profile and business account  --}}
                            ...
                            <div class="mt-3 card-body" style="background-color:#fcf8e3;color:#8a6d3b" align="left">
                                ...
                                <p class=""
                                    ...
                                    1. Delete your account from Mpingi Market platform
                                    here<br><Br>
                                    2. Delete all your posted Products
                                    <br><Br>
                                    3. Delete your Shop
                                    <br><Br>
                                    4. Erase your message history
                                </p>
                            ...
                            <div class="mt-3 mb-3 card" style="border:none;">
                                <div class="card-header"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <center>
                                                <h6 style="font-weight:bold"> Want to change <i
                                                        class="mt-2 fa fa-envelope fa-2x"></i> Free
                                                    email instead?</h6>
                                            </center>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body" style="background-color:#fcf8e3;color:#8a6d3b" align="left">
                                    ...
                                    <p class="py-1"
                                        style="text-align:center;bacground-color:#fcf8e3;color:8a6d3b;border:none;font: 10pt/130% Helvetica, Arial, sans-serif">
                                        <a href="change_email.php" class="tab_">click here</a></p>
                                ...
                                <div class="mt-3 card-body" style="background-color:#fcf8e3;color:#8a6d3b" align="left">
                                    ...
                                    <p class=""
                                        style="text-align:center;bacground-color:#fcf8e3;color:8a6d3b;border:none;font: 10pt/130% Helvetica, Arial, sans-serif">
                                        To delete your account, just click on DELETE MY ACCOUNT button below
                                    </p>
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <button type="submit"
                                                class="mt-3 btn btn-outline btn-lg w-100 DetailsBtnsdel2_">
