                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                {{-- @foreach ($subservice_name_3 as $x)
                                   {{ $x->sub_service_3_name }}
                                @endforeach --}}
                                @foreach ($servicesid as $row)
                                    ...
                                    <div class="col-11">
                                        ...
                                        <a href="#" class="hrefCss3s" style="color:#fff">@foreach ($subservice_name as $w){{ $w->sub_service_name }}  @endforeach</a>
                                        <font color="#ff7519">&nbsp;&nbsp;» </font>
                                        <a href="#" class="hrefCss3s" style="color:rgb(255, 117, 25)">@foreach ($subservice_name as $w){{ $w->sub_service_name }}  @endforeach</a>
                                </div>
                                @endforeach
                    ...
                    <div class="card-body">
                        ...
                        <form id="form-id" enctype="multipart/form-data">
                              @foreach ($getbusinessdata as $user)
                                ...
                                <div class="row">
                                    <div class="mt-0 col-md-6">
                                        @foreach ($subservice_name as $w)
                                        <label style="color:#666"><font color="red">*</font> {{ $w->sub_service_name }} Name</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control " name="universities_name" placeholder="{{ $w->sub_service_name }} Name">
                                        </div>
                                        @endforeach
                                        <span class="text-danger">
                                            <strong id="test-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                          </span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 row">
                                    <div class="mt-0 col-md-12">
                                        ...
                                        <div class="form-group">
                                            <textarea class="ckeditor form-control description" id="editor1" name="editor1"></textarea>
                                        </div>
                                        <span class="text-danger">
                                ...
                                <div class="row">
                                    <div class="mt-1 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger">
                                                <strong id="tel-error" style="color:#dc3545;font: 10pt/130% Helvetica, Arial, sans-serif;"></strong>
                                              </span>
                                        </div>
                                    </div>
                                    <div class="mt-1 col-md-6">
                             ...
                             <div class="mt-3 mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                          ...
                                          @endforeach
                                          @foreach ($sub_services_three  as $t)
                                           <input type="hidden" name="sub_service_id" value="{{ $t->sub_service_id }}">
                                           <input type="hidden" name="sub_service_1_id" value="{{ $t->sub_service_one_id }}">
                                           <input type="hidden" name="sub_service_2_id" value="{{ $t->sub_service_two_id }}">
                                           <input type="hidden" name="sub_service_3_id" value="{{ $t->id }}">
                                          @endforeach

                                          <input type="hidden" name="ad_type" value="0">
                                        <button type="button" class="mt-3 btn-basiclistingbusiness btn btn-outline btn-lg w-100 DetailsBtns2_">
