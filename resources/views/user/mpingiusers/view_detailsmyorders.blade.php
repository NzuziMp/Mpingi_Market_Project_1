                                             ...
                                             <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                                                <div class="">
                                                    ...
                                                    <div class="overlay overlayTop1_">
                                                        ...
                                                        <h2 id="cssh3">
                                                            <a href="{{ route('user.editproductitem', ['upload_id' =>$photoIDS ])}}" style="text-decoration: none;color:#fff"><b><i class="fa fa-eye"></i> View products</b></a>
                                                            <br><br>
                                                ...
                                                @forelse ($getimageid as $row)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <p>
                                                            ...
                                                            <span class="titleDetails d-flex">Views: {{ $row->views }}</span>
                                                        ...
                                                        <div>
                                                                <span>
                                                                 <button type="button"
                                                                    ...
                                                                    <img src="{{ asset('assets/images/share1.png') }}" width="20" height="20" title="Share" alt=""
                                                                    style="background-color:transparent; border:none;"> Share</button>
                                                                </span>
                                                                ...
                                                                data-bs-target="#sellerbuyer_Modal"> <button type="button"
                                                                    ...
                                                                    @include('user.modal.viewbuyersellerModal')
