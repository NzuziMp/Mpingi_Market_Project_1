            ...
            <div class="row g-1">
                ...
                <div class="mb-4 col-lg-8 mb-lg-0">
                    ...
                    <div class="card-body">
                       ...
                       @foreach ($postnumber as $row)
                        <span style="font-weight: bold"><span class="badge rounded-pill bg" style="background-color: #FE980F;color:#ffffff">{{ $row->post_number }}</span> <font style="font: 10pt/130% Helvetica, Arial, sans-serif; color:#666">Days</font> </span>   
                       @endforeach
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="mt-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control oldprice" id="oldprice" placeholder=""  name="old_price">
                                            <span class="text-danger">
                          ...
                          <div class="row g-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-check">
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-1"  id="max-height"  style="display: none;"><input type="text" class="shipping_price" id="inputtext" name="shipping_price" value="0" width="10px"></div>&nbsp;<div class="flex-1"><div class="mt-2" id="max-height1" style="display: none;" style=";color:#ff7519;border:none;font: 10pt/130% Helvetica, Arial, sans-serif;cursor: none;">UGX USh</div></div>
                                    </div>
                             ...
                             <div class="mt-3 row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="mt-3 btn-product-item-paid btn btn-outline btn-lg w-100 DetailsBtns2_">
