                    ...
                    <div class="mb-3 card card6">
                        ...
                        @foreach ($fetchAllJobsItems as $user)
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mt-2 form-group">
                                        ...
                                        <input type="text" class="form-control" id="company_name" name="company_name" value="{{ $user->company_name }}" placeholder="">
                                    </div>
                                    <span class="text-danger">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="2" id="job_description" name="job_description" class="form-control"
                                            placeholder=""> {!!  html_entity_decode($user->job_description) !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-2 row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="2" id="address" name="address" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mt-2 form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="phone" name="phone" value="{{ $user->phone }}">
                                    </div>
                                    <span class="text-danger">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="hidden" name="job_id" value="@foreach ($getjobsItems as $r) {{ $r->id }} @endforeach">
                                        <button type="button" class="mt-3 btn-update-jobs btn btn-outline btn-lg w-100 DetailsBtns2_">
