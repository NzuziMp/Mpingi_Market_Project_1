    ...
    <section class="py-2 border-bottom " id="features">
        <div class="container-fluid">
            ...
            <div class="row g-1">
                ...
                <div class="mb-4 col-md-2 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            style="background-color:#464444;border-bottom:5px solid #2e2d2d;color:#FF7519;font-weight:bold">
                            <div class="row">
                                <span class="hrefCss3s" style="color:#FFF"><i class="fas fa-image"
                                        style="font-size:1.3rem;"></i> Picture Settings</span>

                            </div>

                            {{-- <div class="col-1"><i class="fa fa-times text-dark close-icon6"></i></div> --}}
                        </div>
                        @forelse ($getimageid as $row1)
                        <div class="card-body">
                            <p style="font: 10pt/130% Helvetica, Arial, sans-serif;color:#666">
                                {{-- <a href="#" data-bs-toggle="modal" data-bs-target="#addnewPhotoModal{{ $row1->id }}" class="hrefCss"><i class="fa fa-plus-square" style="font-size:1.2rem;"></i>
                                    Add New Picture </a><Br><Br> --}}
                                {{-- <a href="" class="hrefCss"><i class="fa fa-minus-square" style="font-size:1.2rem;"></i>
                                    Delete Picture </a><Br><Br>
                                <a href="" class="hrefCss"><i class="fas fa-sync-alt" style="font-size:1.2rem;"></i>
                                    Change Picture</a><Br> --}}
                            </p>
                        </div>
                        @empty
                ...
                @include('user.modal.addnewphoto')
                <div class="mb-4 col-md-6 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                <span class="hrefCss3s" style="color:#FFF"><i class="fas fa-image"
                                        style="font-size:1.3rem;"></i> Mpingi Project</span>
                            ...
                            <div class="mt-3 row">
                                ...
                                <div class="mt-3 card-body" style="background-color:#fcf8e3;color:#8a6d3b" align="left">
                                    ...
                                    <p class=""
                                        ...
                                        <i class="fa fa-minus-square" style="font-size:1.3rem;"></i> Check the radion
                                        Button <input class="form-check-input" type="checkbox" value=""
                                            id="flexCheckDefault" style="font-size:1.3rem;"> and click the Delete button
                             ...
                             <form id="form-reset">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <button type="button"  id="removeAll1" class="mt-3 removeAll1 btn btn-outline btn-lg w-100 DetailsBtns2_" disabled="disabled">
                                               Delete</button>
                                        </div>
                                    </div>
                                    <div class="col-md-2"></div>
                                ...
                                <div class="mt-3 row">
                                    @forelse ($viewImage as $row)
                                    <div class="mb-3 col-md-4">

                                        <img class="card-img-top"
                                            src="{{ (!empty($row->image_name)) ? url('/storage/assets/uploads', $row->image_name) : url('/storage/assets/images/avatar_nzuzi_default.png')}}"
                                            class="img-thumbnail" height="180px">
                                            <input type="hidden" name="upload_id" id="upload_id" value="{{ $row->upload_id }}">
                                            <input type="hidden" name="image_name" id="image_name" value="{{ $row->image_name }}">
                                            <input type="checkbox" class="form-check-input sub_chk"  data-id="{{ $row->id }}"  style="position: relative; float: left; margin-left: 5px;top:-180px;border-color: rgb(165, 7, 7)" />
                                ...
                                <div class="mt-2 row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                           ...
                                           <a href="{{ route('user.purchases') }}" class="hrefCss4_"> <button type="button" class="mt-3 btn btn-outline btn-lg w-100 DetailsBtns2_">
                                               Back</button></a>
                                        </div>
                                    </div>
                                    <div class="col-md-2"></div>
