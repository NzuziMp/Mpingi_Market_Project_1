                ...
                <div class="mb-4 col-md-7 mb-lg-0">
                    <div class="mb-3 card card6">
                        <div class="card-header"
                            ...
                            <div class="row">
                                <div class="col-11"><i class="fas fa-tachometer-alt"></i> Dashboard
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 row g-1">
                                ...
                                <div class="col-md-4">
                                    <div class="card card1" style="border-color: #ff7519">
                                        <div class="card-header" style="background-color: #ff7519;color:#ffffff">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2"><i
                                                        class="text-white fa fa-times text-dark close-icon1"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p class="text-center card-title" style="color:#ff7519">
                                                <i class="py-3 mx-3 fa fa-tags fa-5x"></i>
                                            </p>
                                            <p>
                                                <a href="" class="hrefCsslink_x">Free
                                                    Products
                                                    <!--<span class="badge_3">2</span>-->
                                                     <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                                </a>
                                            </p>
                                            <hr>
                                            <p class="mb-3 hrefCsslink_x">
                                        ...
                                        <div class="card card3">
                                            <div class="card-header" style="background-color: #ff7519;color:#ffffff">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-2"><i
                                                            class="text-white fa fa-times text-dark close-icon3"></i>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <p class="text-center card-title" style="color:#ff7519">
                                                    <i class="py-3 mx-3 fa fa-shopping-cart fa-5x"></i>
                                                </p>
                                                ...
                                                <p class="mb-3 hrefCsslink_x">
                                                    ...
                                                    My Sales
                                                    <span
                                                        style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                                </p>
                                        ...
                                        <div class="card card3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="text-center card-title" style="color:#ff7519">
                                                    <i class="py-3 mx-3 fa fa-gift fa-5x"></i>
                                                </p>
                                    ...
                                    <div class="mt-2 card card4" style="border-color: #f25433;">
                                        <div class="card-header" style="background-color: #f25433;color:#ffffff">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2"><i
                                                        class="text-white fa fa-times text-dark close-icon4"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p class="text-center card-title" style="color:#f25433">
                                                <i class="py-3 mx-3 fa fa-paper-plane fa-5x"></i>
                                            </p>
                                            ...
                                            <p class="mb-3 hrefCsslink_x">
                                                ...
                                                Product Feedback
                                                @if($countfeedback != 0)
                                                  <span class="badge_3">({{ $countfeedback }})</span>
                                                @else
                                                   <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                                @endif
                                            </p>
                                ...
                                <div class="col-md-4">
                                    <div class="card card2" style="border-color: #5a88ca">
                                        <div class="card-header" style="background-color: #5a88ca;color:#ffffff;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2"><i
                                                        class="text-white fa fa-times text-dark close-icon2"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p class="text-center card-title" style="color:#5a88ca">
                                                <i class="py-3 mx-3 fa fa-wrench fa-5x"></i>
                                            </p>
                                            {{-- <p>
                                                <a href="" class="hrefCsslink_x">Free
                                                    Products
                                            ...
                                            <h4 align="center" style="color:#5a88ca">
                                                My Business
                                            </h4>
                                            {{-- <p class="text-center card-title" style="color:#5a88ca">
                                                <i class="py-3 mx-3 fa fa-briefcase fa-5x"></i>
                                            </p> --}}
                                            <p class="mb-3 hrefCsslink_x">
                                                <i class="fas fa-bullseye" style="font-size:8px"></i>
                                                Free Services
                                            ...
                                            <h4 align="center" style="color:#5a88ca">
                                                My Industries And Manufacturers
                                            </h4>
                                            <p class="text-center card-title" style="color:#5a88ca">
                                                <i class="py-3 mx-3 fa fa-industry fa-5x"></i>
                                            </p>
                                            <p class="mb-3 hrefCsslink_x">
                                                <i class="fas fa-bullseye" style="font-size:8px"></i>
                                                Free Services
                                ...
                                <div class="col-md-4">
                                    <div class="card card3" style="border-color: #00a61c">
                                        <div class="card-header" style="background-color: #00a61c;color:#ffffff">
                                            <div class="row">
                                                <div class="col-10">
                                                    <h4 align="center">
                                                        My Jobs
                                        ...
                                        <div class="card-body">
                                            <p class="text-center card-title" style="color:#00a61c">
                                                <i class="py-3 mx-3 fa fa-cogs fa-5x"></i>
                                            </p>
                                            <p class="mb-3 hrefCsslink_x">
                                                <i class="fas fa-bullseye" style="font-size:8px"></i>
                                                Free Jobs
                                            ...
                                            <h4 align="center" style="color:#00a61c">
                                                JOB SEEKERS
                                            </h4>
                                            ...
                                            <p class="text-center card-title" style="color:#00a61c">
                                                <i class="py-3 mx-3 fa fa-reply-all fa-5x"></i>
                                            </p>
                                    ...
                                    {{-- Ratings --}}
                                    <div class="mt-2 card card6" style="border-color: #ffad41">
                                        <div class="card-header" style="background-color: #ffad41;color:#ffffff">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2"><i
                                                        class="text-white fa fa-times text-dark close-icon6"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p class="text-center card-title" style="color:#ffad41">
                                                <i class="py-3 mx-3 fa fa-star fa-5x"></i>
                                            </p>

                                            <p class="mb-3 hrefCsslink_x">
                                                Orders waiting feedback
                                                <!--<span class="badge_3">0</span>-->
                                                 <span style="font: 10pt/130% Helvetica, Arial, sans-serif;">(0)</span>
                                            </p>
                                    ...
                                    {{-- Notifications --}}
                                    <div class="mt-2 card card7" style="border-color: #ffd900">
                                        <div class="card-header" style="background-color: #ffd900;color:#ffffff">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2"><i
                                                        class="text-white fa fa-times text-dark close-icon7"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p class="text-center card-title" style="color:#ffd900">
                                                <i class="py-3 mx-3 fa fa-bell fa-5x"></i>
                                            </p>

                                            <p class="mb-3 hrefCsslink_x">
                                                Items waiting for approval
                                                <span class="badge_3">{{ $countWaitingforApproval }}</span>
                                            </p>
                                            {{-- <p class="mb-3 hrefCsslink_x">
                                                Items Approved
                                                <span class="badge_3">{{ $countItemApproved }}</span>
                                            </p> --}}

                                            <p class="mb-3 hrefCsslink_x">
                                                Items Canceled
                                                <span class="badge_3">{{ $countcancelmyOrder }}</span>
                                            </p>
