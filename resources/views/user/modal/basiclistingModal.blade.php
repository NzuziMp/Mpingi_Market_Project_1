<div class="modal fade" id="basiclistingModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="row g-1">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3 card">
                            ...
                            <form action="{{ route('user.basiclistingbusinessesPostserviceID', ['id'=> encrypt(1)]) }}" method="GET">
                                @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3 card">
                            ...
                            <form action="{{ route('user.basiclistingindustries') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{ encrypt(1) }}">
                            <div class="mx-2 mb-2 form-group">
                                <center><button type="submit"
