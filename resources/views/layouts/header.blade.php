...
<head>
    ...
    <title> @if(session()->get('locale') === 'fr')  Marché de Mpingi | Plateforme de marché en ligne gratuite  @else Mpingi Market | Free Online Marketplace Platform @endif</title>
...
<body class="flexcroll">
    ...
    <div id="navbar">
        ...
        <nav id="navbar_main" class="mb-0 shadow-sm navbar navbar-expand-lg navbar-light mobile-offcanvas" style="background-color: #fff;">
            ...
            <div class="px-5 mx-auto d-block">
