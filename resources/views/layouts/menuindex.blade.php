                    ...
                    <div class="mb-3 card card1">
                        <div class="card-header"
                            ...
                            <div class="row">
                                ...
                                <div class="col-10"><i class="fas fa-list"></i> <span class="counter" data-target="3140">0</span>  @if(session()->get('locale') === 'fr')  CATÉGORIES  @else CATEGORIES @endif</div>
                  ...
                  {{-- start country --}}
                    <div class="card card2 mb-3">
                        ...
                        <div class="card-body" style="-7px">
                            <div class="row">
                                @foreach ($countryGroupCount as $c)
                                <div class="mb-3 col-4">
                                    <a href="{{ route('viewcountryproducts2',['country_id' => encrypt($c->country_id), 'id' => encrypt(1)]) }}"> <img
                                        src="{{ url('assets/flags/'.$c->flag) }}" alt=""
                                        width="30" height="20" class="img_icons_2"  data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="{{$c->name}}&nbsp;{{$c->total_countries}}" id="imgBorder">
                                    </a>
                                </div>
                                @endforeach
                                <div class="card">
                                    <div class="mt-2 card-body">
                                        <p id="cardsearch" data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            id="imgBorder"> <a href="{{ route('viewallcountries') }}" class="current_link hrefCss"><i class="fa fa-search-plus"></i> <span
                ...
                <div class="mb-5 col-lg-8 mb-lg-0">
                    <div class="card card5">
                        <div class="card-header"
                            ...
                            @endphp
                            <div class="row">
                                <div class="col-11"><i class="fa fa-tags"></i> <span class="counter" data-target="{{ $countallproducts }} ">0</span>  @if(session()->get('locale') === 'fr')  PRODUITS PRÈS DE CHEZ VOUS  @else PRODUCTS NEAR YOU @endif</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="@if(session()->get('locale') === 'fr')  Rechercher des mots-clés...  @else Search Keywords... @endif" id="search_inputs">
                             ...
                             <div class="col-12">
                                ...
                                <div class="table-data">
                                    <div class="row g-1" id="dynamic_content">
                                        ...
                                        <div class="col-md-3 col-6 d-flex justify-content-center fade_in u-fade-type-left js-scroll-trigger">
                                            <div class="mb-4 card"> {{-- shadow-sm --}}
                                                <div class="containeroverlay">
                                                    <div class="">
                                                        <img class="card-img-top_ embed-responsive-item card-img-top"
                                                        ...
                                                        <div class="text">
                                                            <h3 id="cssh2" class=""><i
                                                              ...
                                                              @if(!Auth::check())
                                                                    ...
                                                                    <a href="javascript:void(0)" id="removeunderline">
                                                                        <i class="fa fa-gift"></i> COMMANDEZ!
                                                                    </a>
                                                                    @else
                                                                    <a href="javascript:void(0)" id="removeunderline">
                                                           ...
                                                           <br><br>
                                                                ...
                                                                <a href="{{ route('guest.viewdetailsitem', ['upload_id' => encrypt($row->ImageIDS), 'product_id' => encrypt($row->ProductItem_id),'product_type' => $row->product_type]) }}" id="removeunderline">
                                                                    <i class="fa fa-tag"></i> DÉTAILS DU PRODUIT
                                                                </a>
                                                                @else
                                                                <a href="{{ route('guest.viewdetailsitem', ['upload_id' => encrypt($row->ImageIDS), 'product_id' => encrypt($row->ProductItem_id),'product_type' => $row->product_type]) }}" id="removeunderline">
                                                                ...
                                                                <a href="{{ route('g.shop_number',['upload_id' => encrypt($row->ImageIDS), 'id'=> encrypt($row->userid)]) }}" id="removeunderline">
                                                                    <i class="fa fa-shopping-cart"></i> VOIR LE MAGASIN
